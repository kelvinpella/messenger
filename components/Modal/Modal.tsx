      ...
      <Dialog as="div" className="z-50 relative" onClose={onClose}>
        ...
        <div className=" fixed inset-0 z-10 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
            ...
            >
              <Dialog.Panel className=" relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 text-left shadow-lg transition-all w-full sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
